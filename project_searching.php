...
if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1){
	...
	//Create query
	$qry = "SELECT FIELD,TOPIC,STIPEND,USER_ID 
			FROM STUDENT,PROJECT
			WHERE STUDENT.TECHNICAL=PROJECT.REQUIREMENT";
	//Execute query
...
<li> NAME: '.$row['TOPIC'].'</li>
<li> STIPEND: '.$row['STIPEND'].'</li>
<li><a href : "displayproject.php" >more.... </a></li>
</ul>
			</p>
			</div>';
