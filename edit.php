		...
		<form action="update_students.php" method="post">
			<table cellpadding = "10">
				...
				<tr>
					...
					<td><input type="text" name="email" maxlength="25" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;"></td>
