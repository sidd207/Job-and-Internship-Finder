...
$row = mysqli_fetch_assoc($result);
		...
		<div id="obj">
			...
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>HD</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['HD'].'</p>
			</div>
			...
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>TO</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['TO'].'</p>
			</div>
			
			<div id="obj">
			
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>SPECIALITY</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['SPECIALITY'].'</p>
			</div>
			...
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">Available on request</p>
				...
				<center>	<a href="edit2.php"><input type="button" name="fname" maxlength="25" value="submit" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;" /></a>
							</center>
							';
