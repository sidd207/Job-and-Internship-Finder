...
$row = mysqli_fetch_assoc($result);
	...
	<body background="images/215.jpg">
		<div class="navbar navbar-fixed-top" style="left: 0; right: 0; top: 0; height: 80px">
			...
			<br><br><br><br><br><br>
		<center><h1>PROJECT FORM</h1>
		<form action="edit_project.php" method="post">
			<table cellpadding = "10">
				<tr>
					<td class="auto-style3">TOPIC*</td>
					<td><input type="text" name="topic" maxlength="25" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="auto-style3">requirement</td>
					<td><input type="text" name="requires" maxlength="16" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;"></td>
