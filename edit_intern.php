...
session_start();
	...
	if ($_POST['submit'] == 'Submit'){			
		...
		if(!($_POST['field'] && $_POST['location']&&$_POST['u_id'] )){
		...
		if($validationFlag){
			...
			//Create Insert query
			$query = "INSERT INTO INTERN
						(FIELD,REQUIRES,POST,STIPEND,LOCATION,S_DATE,E_DATE,U_ID,USER_ID) 
						VALUES 
						('$field',$requires,$post,$stipend,$location,$dob,$dob1,$u_id,$email)";
