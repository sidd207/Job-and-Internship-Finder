	...
	if ($_POST['submit'] == 'Submit'){			
		...
		if($validationFlag){
			...
			if(!$db){
				...
				print_r($_POST);
			//Create Insert query
			$query = "INSERT INTO PROFESSOR(FNAME,LNAME,COMPANY,POST,EXP,EMAIL,UG,PG,ANY,SEX) VALUES ('$fname',$lname,$company,$post,$exp,$email,$ug,$pg,$any,$sex)";
