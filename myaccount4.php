...
<b>EXPERIENCE</b>'.$row['EXP'].'<br>
			...
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">Available on request</p>
				...
				<center>	<a href="edit3.php"><input type="button" name="fname" maxlength="25" value="submit" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;" /></a>
							</center>
							';
