						...
						<ul class="nav navbar-nav pull-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<a href="myaccount1.php"><span class="glyphicon glyphicon-refresh"></span> Update Profile</a>
									</li>
...
$row = mysqli_fetch_assoc($result);
		...
		<div id="obj">
			...
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>UG</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['UG'].'</p>
			</div>
			...
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>PG</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['PG'].'</p>
			</div>
			
			<div id="obj">
			
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>ANY</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">'.$row['ANY'].'</p>
			</div>
			...
			<div id="per">
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>PERSONAL INFORMATION </h3></div>
...
<b>SEX</b>'.$row['SEX'].'<br>
			...
			<div id="ref">
			<div style="height:30px;width:720px;background-color:yellow;margin-left:10px"><h3>Reference</h3></div>
			<p style="font-size:15px;font-style: normal;font-weight:bold;margin-left:10px">Available on request</p>
			</div>
			
			
			
				<center>	<a href="edit1.php"><input type="button" name="fname" maxlength="25" value="submit" style="height: 30px; width: 250px; box-shadow:8px 8px 20px;background-color:rgba(255,255,255,0.3);border-radius:5px;" /></a>
							</center>
							';
